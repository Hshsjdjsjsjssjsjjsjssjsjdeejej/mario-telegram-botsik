...
TELEGRAM_BOT_TOKEN = "8574471908:AAG4VG_nwiU1rYmINrDPIKMX8rt7i_zegQs"
...
def call_llm_api(user_id, message_text): 
    ...
    system_prompt = SYSTEM_PROMPT_TEMPLATE.format(
        creator_name="Каримов Кирилл Александрович",
        current_date=current_time_info.split('.')[0].strip(), 
        current_time_moscow=current_time_info.split('.')[1].strip()
    )
...
if __name__ == '__main__':
    ...
    print("НЕ ЗАБУДЬТЕ ЗАМЕНИТЬ 'YOUR_TELEGRAM_USER_ID' (если можете) на ваш реальный ID Telegram!")
